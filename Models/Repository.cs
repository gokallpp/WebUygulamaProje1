...
namespace WebUygulamaProje1.Models
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public Repository(UygulamaDbContext uygulamaDbContext)
        {
            ...
            _uygulamaDbContext.Kitaplar.Include(k => k.KitapTuru).Include(k => k.KitapTuruId); // Kitaplar tablosunu KitapTuru ile birlikte çekmek için Include kullanıyoruz. Böylece KitapTuru bilgilerine de erişebiliriz.
        }
